...
### US-006: 补料人员查看货道余量并执行补料
**Description:** 作为补料人员，我希望按设备查看货道余量、关联物料和商品编码，并执行补料或发货，以便避免缺料停机。

**Acceptance Criteria:**
- [ ] 物料页可按设备展示 6 类货道分组：咖啡豆仓、牛奶&水、糖浆、前/后道粉、包材、制冰机。
- [ ] 货道卡片展示货道名称、关联物料、商品编码、剩余量、预警值、告警值和状态。
- [ ] 售罄、告急、正常状态视觉可区分。
- [ ] 支持从货道卡片进入发货、补充、编辑货道名称、编辑关联物料。
- [ ] 编辑货道名称和编辑关联物料分别由独立权限控制。
- [ ] 补充弹窗使用“在当前库存上增加输入值”的流程，并提供“重置为 0”能力。
- [ ] 页面无明显空白崩溃或脚本报错。
- [ ] **Verify in browser using dev-browser skill**

### US-007: 运营人员查看运维清单和发货单
**Description:** 作为运营人员，我希望查看物料运维清单、打印发货单并按权限作废本人发货单，以便安排补给执行。

**Acceptance Criteria:**
- [ ] 物料页可跳转运维清单页。
- [ ] 运维清单默认展示“我的发货单”，具备权限时展示“全部发货单”。
- [ ] 发货单明细展示货道名称、物料名称、商品编码、数量和单位。
- [ ] 支持打印发货单。
- [ ] 待发货单可由创建人作废，且作废必须填写原因。
- [ ] 添加物料页基于当前商户物料表选择物料，并生成发货单。
- [ ] 页面无明显空白崩溃或脚本报错。
- [ ] **Verify in browser using dev-browser skill**
