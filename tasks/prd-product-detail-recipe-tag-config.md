...
> 使用说明：`Markdown` 版本适合在仓库内查看；如需在浏览器或飞书文档中阅读，优先使用同目录的 [prd-product-detail-recipe-tag-config.html](./prd-product-detail-recipe-tag-config.html)。
...
![US-001 配方配置入口](../screenshots/prd-product-detail/us001.png)
...
![US-002 标签配置抽屉](../screenshots/prd-product-detail/us002.png)
...
![US-003 修改配方界面](../screenshots/prd-product-detail/us003.png)
...
![US-004 上传配方与恢复出厂设置入口](../screenshots/prd-product-detail/us004.png)
...
![US-005 标签同步确认弹窗](../screenshots/prd-product-detail/us005.png)
...
![US-006 配方关联确认弹窗](../screenshots/prd-product-detail/us006.png)
...
- FR-7：附加价格默认为 `0`，不要求用户必须手动填写。
- FR-8：标签配置中的多语言内容应与当前设备支持语言保持一致。
