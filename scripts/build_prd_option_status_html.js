#!/usr/bin/env node
/**
 * 从 tasks/prd-product-option-display-status.md 生成自包含 HTML 版本。
 *
...
const MD_PATH = path.join(ROOT, 'tasks', 'prd-product-option-display-status.md');
const OUT_PATH = path.join(ROOT, 'tasks', 'prd-product-option-display-status.html');
const TITLE = '产品需求文档：商品选项点单屏展示状态（隐藏 / 不可用）';
